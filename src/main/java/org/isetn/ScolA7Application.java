...
public class ScolA7Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Matiere m1 = matiereRepository.save(new Matiere(null,"Flutter",null));
		Matiere m2 = matiereRepository.save(new Matiere(null,"BigData",null));
		Matiere m3 = matiereRepository.save(new Matiere(null,"SOA",null));
